...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/logoMid.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pwTx, javax.swing.GroupLayout.Alignment.TRAILING)
...
//        }
    ...
    private void enableLoginBtn() {
        loginBt.setEnabled(pwTx.getPassword().length>0);
    }
    ...
    private void getPassword() {
        try {
            ManagementController.getPassword();
        } catch (SQLException ex) {
            try {
                boolean createDatabase = DatabaseAutoCreater.createDatabase();
                if (!createDatabase) {
                    getPassword();
                }
